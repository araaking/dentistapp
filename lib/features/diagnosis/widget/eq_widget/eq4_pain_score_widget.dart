...
class Eq4PainScoreWidget extends StatelessWidget {
  final QuestionModel question;
  const Eq4PainScoreWidget({super.key, required this.question});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        // Separate image for EQ4; fallback UI if asset not available
        Image.asset(
